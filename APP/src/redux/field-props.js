export default [
    { id: 1, name: "INT", type: "int", props: [{ name: "AUTO_INCREMENT", label: "AUTO_INCREMENT", type: "bool" }, { name: "PATTERN", type: "text", label: "Định dạng" }] },
    { id: 2, name: "INT UNSIGNED", type: "int", props: [{ name: "AUTO_INCREMENT", label: "AUTO_INCREMENT", type: "bool" }, { name: "PATTERN", type: "text", label: "Định dạng" }]},
    { id: 3, name: "BIG INT", type: "int", props: [{ name: "AUTO_INCREMENT", label: "AUTO_INCREMENT", type: "bool" }, { name: "PATTERN", type: "text", label: "Định dạng" }] },
    { id: 4, name: "BIG INT UNSIGNED", type: "int", props: [{ name: "AUTO_INCREMENT", label: "AUTO_INCREMENT", type: "bool" }, { name: "PATTERN", type: "text", label: "Định dạng" }]},
